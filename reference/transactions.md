...
MODM's transaction usage is inspired by Qmgo. Combined with MODM's feature of directly returning structured data, this further reduces the amount of code needed.

## Usage

The following example demonstrates a transaction for inserting data and increasing prices.
